# 大喜利お題生成アプリ - Codex ガイド

## プロジェクト概要
OpenAI GPT、Codex、Geminiの3つのAIを活用して、多様で創造的な大喜利のお題を大量生成するNext.jsアプリケーション
...
- `@anthropic-ai/sdk` - Codex API クライアント
